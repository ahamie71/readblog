                    ...
                    <div class="col-md-4">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <button a href="index.php?action=displayonepost&id=<?= $post['id'] ?>" class="btn mr-2"><i class="btn btn-primary"></i>Lire la suite</button>


                                <button a href="index.php?action=displayonepost&id=<?= $post['id'] ?> type="button" class="btn btn-primary">Primary</button>
                            </div>
                        </div>
                    </div>
                </div>
