            ...
            <div class="post-container">
               <?php foreach($articles as $posts):?>
                <div class="container mt3">
                    ...
                    <img src ="<?php echo './public/image/'.$posts['image']?> " alt="mon image"  class="slider-image">
                    <div class="card-body">
                        <h4><a href= "index.php?action=displayonepost&id=<?php echo $posts['id']?> "><?= $posts['title']?></a></h4>     
                        &nbsp;
                        <i><?php echo date( 'd F,Y',strtotime($posts['created_at']));?></i><p>ECRIT dans la categorie:
