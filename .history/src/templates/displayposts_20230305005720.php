...
<?php foreach($articles as $post):?>
    <div class ="card-group">
     <div class="article">
      ...
      <div class="right">
        <a href= "index.php?action=displayonepost&id=<?php echo $post['id']?>"><?= $post['title']?>.....</a></h4>
        ...
        <a href="create.php" class="btn btn-success">Modifier mon  article</a>
        <a href="index.php?action=displayonepost&id=<?php echo $post['id']?>" class="btn btn-primary">DELETE mon article </a>
      </div>
